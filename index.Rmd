...
```{r lollyplot1, out.height = "80%", out.width = "80%"}
knitr::include_graphics("rmd/Fig.S3a.jpg")
```
<div id="fig-caption">
  <b>Figure S2 -</b> Number of studies per acoustic index classified by the diversity measure used to assess the correlation between the acoustic index and biodiversity.
</div>
...
```{r lollyplot2, out.height = "80%", out.width = "80%"}
knitr::include_graphics("rmd/Fig.S3b.jpg")
```
<div id="fig-caption">
  <b>Figure S3 -</b> Number of studies per acoustic index classified by their studied taxon.
</div>
